...
else
{
    ...
    {
        echo "<tr><td>".$row[0]."</td><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$row[5]."</td><td>".$row[6]."</td><td>".$row[7]."</td><td>".$row[8]."</td><td><a href='images/".$row[9]."' target='_blank'>".$row[9]."</a></td><td><a href='images/".$row[10]."' target='_blank'>".$row[10]."</a></td></tr>";
    }
    echo "</tbody></table>";
}
?>
